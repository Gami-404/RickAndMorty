...
export default function Characters() {
    ...
    if (isLoading) {
     ...
     const openDialogHandler = (event:React.MouseEvent<HTMLImageElement, MouseEvent>,character:Character)=>setCharacterDialog(_=>({open:true,character:character}))
  ...
  return (     
        <>
          ...
          <Backdrop sx={{ color: '#fff'}} open={isFetching}> <CircularProgress /></Backdrop>}
